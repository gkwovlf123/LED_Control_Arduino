...
// 데이터 베이스 호스트 이름
#define FIREBASE_HOST  "fb-webandroid-window-default-rtdb.firebaseio.com"

// 데이터 베이스 비밀번호
#define FIREBASE_AUTH "GIW4WiQFTSzVZD0qL6QTjYDi3LOJlwHIeAHBD2xJ"

// Wi-Fi 설정
#define WIFI_SSID "V50ThinQ"
